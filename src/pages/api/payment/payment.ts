...
const submitPaymentService = async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const endpoint:string = restConfiguration.apiCoreHost+"/api/v1/payment/submit";
...
export default submitPaymentService;